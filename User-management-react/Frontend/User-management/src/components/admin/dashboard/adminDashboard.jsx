  ...
  useEffect(() => {
    async function fetchData() {
      await axios
        ...
        .catch((err) => {
          console.log(
            "error at axios fetch in getting user data @ admin dash",
            err
          );
        });
    }
    ...
    <div className="dashboard-container">
      <div className="sidebar">
        ...
        <div className="head-btns">
          <button onClick={navigateToAdminHome} className="home-btn">
            Admin Home
          </button>
      ...
      <div className="dashboard-main">
        <div className="dashboard-header">
          ...
          />
          <button onClick={searchUser} className="search-btn">
            Search
          </button>{" "}
        ...
        <table className="users-table">
          ...
          <tbody>
            {display.length > 0 ? (
              ...
              <tr>
                <td colSpan="5" className="no-user-message">
                  No user found.
                </td>
              </tr>
            ) : (
